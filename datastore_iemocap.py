...
class IemocapDatastore(Datastore):
    ...
    def __init__(self, feature_type: FeatureType) -> None:
        ...
        self.train_mfcc = read_hdf5(f"{PKL_ROOT}h5_data/train_vltp_noised_balanced.h5", "mfcc")
        self.train_emotion = read_hdf5(f"{PKL_ROOT}h5_data/train_vltp_noised_balanced.h5", "emotion_one_hot")
    ...
    def get_pre_train_data(self):
        ...
        mfcc = read_hdf5(f"{PKL_ROOT}h5_data/valid_vltp_noised_balanced.h5", "mfcc")
        emotion = read_hdf5(f"{PKL_ROOT}h5_data/valid_vltp_noised_balanced.h5", "emotion_one_hot")

        return mfcc, emotion, None

    def get_eval_data(self):
        mfcc = read_hdf5(f"{PKL_ROOT}h5_data/test_vltp_noised_balanced.h5", "mfcc")
        emotion = read_hdf5(f"{PKL_ROOT}h5_data/test_vltp_noised_balanced.h5", "emotion_one_hot")
